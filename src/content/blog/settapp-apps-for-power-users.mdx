...
tags: ['apps', 'mac']
featureImage:
  src: ../../assets/setapp-welcome.png
  alt: 'Setapp Welcome Screen'
---
...
Check out this post on Reddit where /u/jkazz18 breaks it down pretty well and even provides a handy calculator spreadsheet to see if it's worth it!

Based on a quick scan, my total savings in the first year would be over 300 dollars!

> <Link href={`https://www.reddit.com/r/macapps/comments/1abqzoe/is_set_app_worth_it/`} class="text-primary-500 hover:text-sky-600 dark:hover:text-primary-400">Is Set App Worth It?</Link>, posted by u/jkazz18 in r/macapps.
