...
featureImage:
  src: ../../assets/dont-keep-your-git-repos-in-icloud.png
  alt: 'Dark illustration of a grinning cloud with glowing eyes looming over a laptop at night, its tendrils lifting ghostly duplicate files out of the file tree on the screen while one tendril dangles a padlocked folder.'
---
