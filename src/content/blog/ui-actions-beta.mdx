...
tags: ['apps', 'mac', 'shortcuts']
featureImage:
  src: ../../assets/ui-actions-beta-test.gif
  alt: 'Gif of a UI Actions Beta creating a Stickies note, bolding the text and then changing the color, then typing a message.'
---
