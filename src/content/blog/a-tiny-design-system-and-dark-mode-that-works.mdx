...
featureImage:
  src: ../../assets/a-tiny-design-system-and-dark-mode-that-works.png
  alt: 'Night workbench lit by a desk lamp with two proof boards clipped side by side, each showing the same set of interface pieces: cards, a pill button, tag chips, and a toggle. The left board is cream with orange elements, the right is dark navy with blue ones. A builder in orange overalls and a hard hat stands between them holding a clipboard, with a warmly lit house in the distance.'
---
