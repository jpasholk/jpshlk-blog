...
3. **Asked me real questions.** Not "are you sure?" busywork — actual decisions: Netlify or Cloudflare? Keep the projects page or fold it into the landing page? And my favorite: *"Your config says `jshlk.com` but your site title says `jpshlk.com` — which is right?"* It found a typo in my canonical domain that had been sitting there the entire time.
...
6. **SEO layer + launch** — the Yoast founder's toolkit, then Cloudflare (parts 7 and 8)

Plus a bonus part 9 on MCP servers, the plumbing that makes AI dev tools way smarter.
