...
tags: ['rebuild', 'ai', 'astro', 'web-development']
featureImage:
  src: ../../assets/rebuilding-my-blog-with-ai.png
  alt: 'Illustration of a house being rebuilt at night: a crane lowers dark code panels into the wooden framing on one side while the finished side glows with browser windows, and a small builder with a blueprint and coffee stands by the front door.'
---
...
The old version of this site was a port of a popular theme, <Link href="https://github.com/timlrx/tailwind-nextjs-starter-blog">tailwind-nextjs-starter-blog</Link>, adapted to <Link href="https://astro.build">Astro</Link>. It served me well while I was learning, but it had problems:
...
I also wanted serious SEO, and it turns out the founder of Yoast (the WordPress SEO plugin that runs half the internet) has been building <Link href="https://joost.blog/astro-seo-complete-guide/">SEO tools for Astro</Link>. That sealed it.
...
Next up: [the five-minute git trick](/blog/back-up-your-site-with-a-git-branch/) that made deleting my entire site feel safe.
