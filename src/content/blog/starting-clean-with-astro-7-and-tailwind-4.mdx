...
The lesson generalizes: a "risky" upgrade is often only risky for code you already have. A clean slate is the cheapest possible time to be on the newest major version — it means no forced migration six months later.
