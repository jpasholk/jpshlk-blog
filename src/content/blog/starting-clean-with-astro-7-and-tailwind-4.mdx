...
featureImage:
  src: ../../assets/starting-clean-with-astro-7-and-tailwind-4.png
  alt: 'Dark blueprint-style illustration of a multi-story building rising from a clean foundation at night, its scaffold drawn in glowing blue code, with floating panels of Astro config code and stacked crates of preserved content beside it.'
---
