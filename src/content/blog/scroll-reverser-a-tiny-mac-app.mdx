...
tags: ['apps', 'mac']
featureImage:
  src: ../../assets/scroll-reverser.png
  alt: 'Scroll Reverser Screenshot'
---
...
## Enter <Link href={`https://pilotmoon.com/scrollreverser/`} class="text-primary-500 hover:text-sky-600 dark:hover:text-primary-400">Scroll Reverser</Link> By Nick Moore

This tiny app completely solves this edge-case issue. You can download it from the link above, or check out the <Link href={`https://github.com/pilotmoon/Scroll-Reverser`} class="text-primary-500 hover:text-sky-600 dark:hover:text-primary-400">GitHub repo</Link>.
