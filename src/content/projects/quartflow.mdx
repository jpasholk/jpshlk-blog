...
No framework here, just plain JavaScript doing the math behind the sliders. It is open source under the MIT license, so borrow whatever is useful. You can try it at <Link href="https://quartflow.jpshlk.com/">quartflow.jpshlk.com</Link>.
